...
class PublicviewTravelImages extends StatelessWidget {
  final String travelogueId;

  const PublicviewTravelImages({Key? key, required this.travelogueId}) : super(key: key);
    ...
    try {
      ...
      if (travelogueId.isNotEmpty) {
        final response = await http.post(
          Uri.parse("$baseUrl/api/PublicviewTravelImages"),
