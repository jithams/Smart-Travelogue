...
class PublicviewTravelVideos extends StatelessWidget {
  final String travelogueId;

  const PublicviewTravelVideos({Key? key, required this.travelogueId}) : super(key: key);
  ...
  Future<void> getData() async {
    try {
      ...
      final response = await http.post(
        Uri.parse("$baseUrl/api/PublicviewTravelVideos"),
