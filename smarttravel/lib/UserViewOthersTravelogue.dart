...
void main() {
  runApp(MaterialApp(
    home: UserViewOthersTravelogue(),
  ));
}

class UserViewOthersTravelogue extends StatefulWidget {
  @override
  _UserAddTravelogueState createState() => _UserAddTravelogueState();
}

class _UserAddTravelogueState extends State<UserViewOthersTravelogue> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Travelogue Details'),
      ),
      body: Padding(
  ...
  Future<Map<String, dynamic>> _fetchFeedback() async {
    ...
    try {
      String url = "$ip/api/UserViewOthersTravelogue";
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(context, MaterialPageRoute(
                          builder: (context) => UserViewTravelImages(travelogueId: travelogueId),
                        ));
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () {
                        String travelogueId = feedback['travelogue_id'].toString();
                        Navigator.pushReplacement(context, MaterialPageRoute(
                          builder: (context) => UserViewImagesVideos(travelogueId: travelogueId),
                        ));
                      },
                    ),
                  ],
